...
public class JugadorController {
	...
	public ResponseEntity<Tirada> tirarDaus(@PathVariable("id") String id){
	...
	public ResponseEntity<HttpStatus> eliminarTiradesJugador(@PathVariable("id") String idJugador) {
	...
	public ResponseEntity<Iterable<Tirada>> llistarTiradesJugador(@PathVariable("id") String id) {
